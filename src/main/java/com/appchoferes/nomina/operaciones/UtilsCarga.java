...
public class UtilsCarga {
    ...
    public static CargasDieselEntity asignarDatosDeCarga(Map<String, Object> campos, CargasDieselEntity cargaExistente){
        ...
        campos.forEach((key, value) -> {
            ...
            Method setter = ReflectionUtils.findMethod(CargasDieselEntity.class, setterName, tipoClase);
    ...
    public static double calcularRecorrido(CargasDieselEntity carga,String ultimoOdometroStr)
    {
