...
import com.appchoferes.nomina.services.NominaServiceOld;
import com.appchoferes.nomina.services.SemanaServiceOld;

@RestController
@RequestMapping("/getNominaChofer")
public class NominaControllerOld {
@Autowired
private NominaServiceOld nominaService;   
